...
function New-FormStringContent($Name, $Value) {
...
function New-FormFileContent($FileName, $FieldName, $ContentType) {
...
function Invoke-BruteResultFileUpload($FileName, $UploadId, $TeamId, [switch]$PromptForSSOToken) {
